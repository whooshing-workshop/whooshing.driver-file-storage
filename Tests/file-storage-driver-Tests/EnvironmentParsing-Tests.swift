...
struct EnvironmentParsingTests {
    ...
    func testEnvironmentDetect() async throws {
        ...
        #expect(project.dbServices[1].dbs[0].parameter.fileStorageKey == wrongApiClientToken)
        ...
        #expect(project.dbServices[1].dbs[1].parameter.fileStorageKey == wrongApiClientToken)
    }
